...
export default function Hero() {
  ...
  return (
    <section className={`${styles.yPaddings} flex flex-col items-center justify-center h-screen bg-fixed bg-center relative`}>
      ...
      <div className='absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-black via-[#4D0026]/50 to-black' />
      <motion.div
      ...
      >
        <div className='flex justify-center items-center flex-col relative z-[2]'>
          <motion.h1
            className='text-white font-bold text-xl tracking-wider md:text-6xl lg:text-7xl xl:text-7xl'
          ...
          >
            <h1 className='text-white font-bold text-xl tracking-wider md:text-6xl lg:text-7xl xl:text-7xl'>the ingredients we all eat?</h1>
          </motion.div>
        </div>
        <div className='flex justify-center items-center flex-col relative z-[2] pt-10'>
          <h1 className='text-xl font-bold tracking-wider md:text-5xl lg:text-6xl xl:text-6xl'>
            <span className='text-[#009900]'>{text}</span>
            <Cursor cursorColor="#009900" />
          </h1>
        </div>
      </motion.div>
    </section>
